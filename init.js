     ...
     */
     ...
     $.ajax({
        ...
        success: function(data, status, xhr) {
            // Khali krdo phle
            if(data.length===0)
                $('#listOfTasks').replaceWith('<ul id="listOfTasks" class="list-group todo-available-tasks"><span class="badge badge-primary badge-pill todo-available-tasks-text">No Tasks Available</span></ul>');
            else
                $('#listOfTasks').replaceWith('<ul id="listOfTasks" class="list-group todo-available-tasks"><span class="badge badge-primary badge-pill todo-available-tasks-text">Available Tasks</span></ul>');
